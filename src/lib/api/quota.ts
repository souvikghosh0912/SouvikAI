...
/**
 * Same estimate from a running character count — used by the streaming
 * paths, which only track output length (avoids allocating a throwaway
 * string of that size just to measure it).
 */
