...
export function ArchivedChatsTab({ onOpenChat }: ArchivedChatsTabProps) {
    ...
    return (
        <div className="space-y-1.5 animate-in fade-in slide-in-from-bottom-2 duration-300 pb-4">
            <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/70 px-0.5 pb-2">
            ...
            <div className="rounded-xl border border-border/40 bg-muted/10 overflow-hidden divide-y divide-border/30">
                {sessions.map((session) => {
                    ...
                    return (
                        ...
                        >
                            {/* Icon */}
                            <div className="h-8 w-8 rounded-lg bg-muted/30 border border-border/40 flex items-center justify-center shrink-0">
                                <Archive className="h-4 w-4 text-muted-foreground/60" />
                            </div>

                            {/* Title + date */}
                            <div className="flex-1 min-w-0">
                                <p className="text-[13px] font-medium text-foreground/90 truncate leading-none">
                                    {session.title}
                                </p>
            ...
            <p className="text-[11px] text-muted-foreground/50 px-1 pt-1">
